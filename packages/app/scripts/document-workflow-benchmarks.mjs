const SOURCE_ROOT = "/Users/storm/Pictures/开发参考文件/标书agent开发相关文件";

export const FORMAL_DOCUMENT_BENCHMARKS = [
  {
    id: "formal-single-long-tech-rewrite",
    category: "single-long-rewrite",
    title: "天河产业园技术部分重构",
    expectedOutput: "outputs/formal-single-long-rewrite.md",
    docs: [
      `${SOURCE_ROOT}/备-天河产业园一期融合算力系统建设项目CPU、GPU节点及云计算服务器采购投标文件电子版-技术部分-烽火.docx`,
    ],
    prompts: [
      ...
      "继续推进，把一份重构后的中文 Markdown 稿件写到 outputs/formal-single-long-rewrite.md。正文至少必须包含以下四个 Markdown 标题：项目理解、结构重组方案、关键技术与实现路径、风险与待确认事项。写完后自检，确保这些标题原样存在，并补齐 coverage/verify 所需状态。",
    ],
    scoreAxes: [
      "tool-path-stability",
      "error-free-routing",
  ...
  },
  {
    ...
    docs: [
      `${SOURCE_ROOT}/智能员工资料/wjw项目伙伴/招标文件-天津市滨海新区卫生健康委员会天津市滨海新区卫生健康信息化平台项目.docx`,
      `${SOURCE_ROOT}/智能员工资料/wjw项目伙伴/产品信息/海滨医院点对点应答.docx`,
      `${SOURCE_ROOT}/智能员工资料/wjw项目伙伴/产品信息/智慧网络医疗服务项目设备参数9.29(1).docx`,
    ],
    prompts: [
  ...
  },
  {
    ...
    docs: [
      `${SOURCE_ROOT}/备-环投数科临沂项目第一包v20250507v1.0(1)(1).docx`,
      `${SOURCE_ROOT}/智能员工资料/ly项目伙伴/临沂招标文件正文.pdf`,
      `${SOURCE_ROOT}/智能员工资料/ly项目伙伴/伙伴资料文档/环投数科临沂项目第一包v20250508终版文件.docx`,
    ],
    prompts: [

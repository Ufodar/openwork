...
export default {
  ...
  "docwriter.ref_category_tender": "Requirement documents",
  ...
  "docwriter.ref_category_history": "Historical reference drafts",
  ...
  "docwriter.assemble_description": "Copies baseline forms (summary sheet/itemized sheet/point-to-point/config list/commitment page) into the target.",
  ...
  "docwriter.facts_title": "Requirement facts",
  "docwriter.facts_tender_source_label": "Requirement document (source of truth)",
  "docwriter.facts_upload_tender_hint": "Upload the requirement file to the corresponding primary-source category.",
  "docwriter.what_it_does": "What it does",
  "docwriter.facts_description": "Extracts project name/code, deadlines, amounts, and other hard facts from the requirement document, then fills the project info table in your template (optional). Saves a facts.json + markdown report to Reports.",
  ...
  "docwriter.select_tender_document": "Select a requirement document",
  "docwriter.run_facts": "Run requirement facts",

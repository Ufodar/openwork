...
export default {
  ...
  "session.knowledge_manage": "Select knowledge",
  "session.knowledge_loading": "Loading attached knowledge bases...",
  "session.knowledge_load_failed": "Failed to load attached knowledge bases.",
  ...
  "session.knowledge_picker_scope_others": "Others",
  "session.knowledge_picker_selected": "Attached to this session",
  "session.knowledge_picker_none_selected": "No knowledge bases are attached to this session yet.",
  "session.knowledge_picker_loading": "Loading knowledge bases...",
  "session.knowledge_picker_empty_mine": "You do not have any knowledge bases yet.",
  "session.knowledge_picker_empty_others": "No other users have visible knowledge bases right now.",
  "session.knowledge_picker_owner": "Owner: {name}",
  "session.knowledge_picker_apply": "Apply",
  "session.knowledge_picker_cancel": "Cancel",
  "session.knowledge_picker_saved": "Knowledge bases updated.",
  "session.knowledge_picker_failed_load": "Failed to load knowledge bases.",
  "session.knowledge_picker_failed_save": "Failed to update attached knowledge bases.",
  "session.knowledge_docs_chunks": "{docs} docs · {chunks} chunks",
  // ==================== Knowledge ====================
  "knowledge.title": "Knowledge",
  "knowledge.subtitle": "Manage session-external knowledge bases",
  "knowledge.description": "Create reusable knowledge bases outside sessions, upload source files, then attach one or more knowledge bases inside a session when retrieval is needed.",
  "knowledge.default_chunking": "Default parsing uses RAGFlow general chunking with a chunk size of 2000.",
  "knowledge.refresh": "Refresh",
  "knowledge.connect_required": "Connect to an OpenWork server to manage knowledge bases.",
  "knowledge.load_failed": "Failed to load knowledge bases.",
  "knowledge.create_title": "Create a knowledge base",
  "knowledge.create_description": "Knowledge bases are owned in OpenWork by user, even though the current server uses one shared RAGFlow API key.",
  "knowledge.create_name_label": "Name",
  "knowledge.create_name_placeholder": "For example: Commercial qualifications",
  "knowledge.create_description_label": "Description",
  "knowledge.create_description_placeholder": "Optional note for teammates",
  "knowledge.create_action": "Create",
  "knowledge.creating": "Creating...",
  "knowledge.create_name_required": "Enter a name for the knowledge base.",
  "knowledge.create_failed": "Failed to create the knowledge base.",
  "knowledge.upload_failed": "Failed to upload knowledge files.",
  "knowledge.files_title": "Uploaded files",
  "knowledge.files_action": "Files",
  "knowledge.files_hide_action": "Hide files",
  "knowledge.files_loading": "Loading files...",
  "knowledge.files_load_failed": "Failed to load knowledge files.",
  "knowledge.files_panel_description": "Original files and parsing status for the selected knowledge base appear here.",
  "knowledge.files_empty": "This knowledge base does not have any files yet.",
  "knowledge.file_size_unknown": "unknown size",
  "knowledge.document_run_done": "done",
  "knowledge.document_run_processing": "processing",
  "knowledge.document_run_fail": "failed",
  "knowledge.document_run_unknown": "unknown",
  "knowledge.delete_document_action": "Delete file",
  "knowledge.delete_document_confirm": "Delete file \"{name}\"?",
  "knowledge.delete_document_failed": "Failed to delete the knowledge file.",
  "knowledge.delete_knowledge_action": "Delete knowledge base",
  "knowledge.delete_knowledge_confirm": "Delete knowledge base \"{name}\"? This also removes the backing dataset from RAGFlow.",
  "knowledge.delete_knowledge_failed": "Failed to delete the knowledge base.",
  "knowledge.deleting_knowledge": "Deleting...",
  "knowledge.mine_title": "My knowledge bases",
  "knowledge.mine_description": "Upload files here, then attach the knowledge base inside any session.",
  "knowledge.mine_empty": "No knowledge bases yet in {workspace}.",
  "knowledge.docs_count": "{count} docs",
  "knowledge.chunks_count": "{count} chunks",
  "knowledge.chunk_method_naive": "naive",
  "knowledge.upload_action": "Upload files",
  "knowledge.uploading": "Uploading...",
  "knowledge.session_external_hint": "Files stay session-external. Sessions only attach knowledge scopes, they do not create hidden datasets.",
  "knowledge.refresh_files": "Refresh files",
  "knowledge.others_title": "Others",
  ...
  "knowledge.details_empty_title": "Choose a knowledge base from the left",
  "knowledge.details_empty_description": "Once selected, this panel shows details, files, and upload or delete actions for that knowledge base.",
  "knowledge.details_shared_hint": "Shared knowledge bases are read-only here and become retrieval sources when attached to a session.",
  "knowledge.details_docs_label": "Documents",
  "knowledge.details_chunks_label": "Chunks",
  "knowledge.details_chunk_method_label": "Chunking",
  "knowledge.status_ready": "ready",
  "knowledge.status_processing": "processing",
  "knowledge.status_degraded": "degraded",
  "knowledge.status_unknown": "unknown",
  // ==================== Commands ====================
  "commands.new": "New",

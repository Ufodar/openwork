...
export default {
  ...
  "docwriter.assemble_description": "将基础表单（摘要表/分项表/点对点/配置清单/承诺页）复制到目标文档。",
  ...
  "docwriter.facts_title": "需求事实抽取",
  "docwriter.facts_tender_source_label": "需求文档（事实来源）",
  "docwriter.facts_upload_tender_hint": "请先上传需求文档到对应的主约束资料分类。",
  "docwriter.what_it_does": "功能说明",
  "docwriter.facts_description": "从需求文档中提取项目名称/编号、工期、金额等硬信息，并可回填到模板中的项目信息表。同时会保存 facts.json 与 Markdown 报告到 Reports。",
  ...
  "docwriter.select_tender_document": "请选择需求文档",
  "docwriter.run_facts": "执行需求事实抽取",

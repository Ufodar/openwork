...
export default {
  ...
  "docagent.preparing_upload_count": "正在准备上传：{count} 个文件",
  ...
  "docagent.target_document_prompt_prefix": "目标文档（工作区相对路径）：{path}",
  "docagent.insert_document_path_into_prompt": "将文档路径插入提示词",
  "docagent.use_in_prompt": "插入提示词",
  "docagent.move_file": "移动文件",
  "docagent.move_folder": "移动文件夹",
  "docagent.delete_file": "删除文件",
  "docagent.delete_folder": "删除文件夹",
  "docagent.move_file_prompt": "移动文件（输入新路径）\n\n当前：{path}",
  "docagent.move_folder_prompt": "移动文件夹（输入新路径）\n\n当前：{path}",
  "docagent.move_path_required": "目标路径不能为空。",
  "docagent.move_path_same": "源路径与目标路径不能相同。",
  "docagent.move_target_exists": "目标路径已存在。",
  "docagent.move_folder_into_self": "不能将文件夹移动到其自身内部。",
  "docagent.moved_file": "已移动文件：{path}",
  "docagent.moved_folder": "已移动文件夹：{path}",
  "docagent.failed_move_file": "移动文件失败",
  "docagent.failed_move_folder": "移动文件夹失败",
  ...
  "docagent.open_session_view": "返回智能体列表",
  "docagent.session": "返回",
  ...
  "docwriter.processing_category": "已上传 {category}，正在刷新列表...",
  "docwriter.more": "更多",
  ...
  "session.knowledge_manage": "选择知识库",
  "session.knowledge_loading": "正在加载已挂载的知识库...",
  "session.knowledge_load_failed": "加载已挂载知识库失败。",
  ...
  "session.knowledge_picker_scope_others": "其他人的",
  "session.knowledge_picker_selected": "当前会话已挂载",
  "session.knowledge_picker_none_selected": "当前会话还没有挂载任何知识库。",
  "session.knowledge_picker_loading": "正在加载知识库列表...",
  "session.knowledge_picker_empty_mine": "你还没有创建任何知识库。",
  "session.knowledge_picker_empty_others": "当前没有其他用户可见的知识库。",
  "session.knowledge_picker_owner": "归属：{name}",
  "session.knowledge_picker_apply": "应用",
  "session.knowledge_picker_cancel": "取消",
  "session.knowledge_picker_saved": "知识库挂载已更新。",
  "session.knowledge_picker_failed_load": "加载知识库列表失败。",
  "session.knowledge_picker_failed_save": "更新知识库挂载失败。",
  "session.knowledge_docs_chunks": "{docs} 个文档 · {chunks} 个切片",
  // ==================== Knowledge ====================
  "knowledge.title": "知识库",
  "knowledge.subtitle": "管理会话外知识库",
  "knowledge.description": "在会话外创建可复用知识库、上传源文件，并在需要检索时将一个或多个知识库挂载到会话中。",
  "knowledge.default_chunking": "默认使用 RAGFlow 通用解析，并按 2000 字切片。",
  "knowledge.refresh": "刷新",
  "knowledge.connect_required": "请先连接 OpenWork 服务器后再管理知识库。",
  "knowledge.load_failed": "加载知识库失败。",
  "knowledge.create_title": "创建知识库",
  "knowledge.create_description": "虽然当前服务器共用同一个 RAGFlow API Key，但知识库归属仍由 OpenWork 按用户维护。",
  "knowledge.create_name_label": "名称",
  "knowledge.create_name_placeholder": "例如：商务资质材料",
  "knowledge.create_description_label": "描述",
  "knowledge.create_description_placeholder": "可选，便于自己或同事理解用途",
  "knowledge.create_action": "创建",
  "knowledge.creating": "创建中...",
  "knowledge.create_name_required": "请先填写知识库名称。",
  "knowledge.create_failed": "创建知识库失败。",
  "knowledge.upload_failed": "上传知识库文件失败。",
  "knowledge.files_title": "已上传文件",
  "knowledge.files_action": "查看文件",
  "knowledge.files_hide_action": "收起文件",
  "knowledge.files_loading": "正在加载文件...",
  "knowledge.files_load_failed": "加载知识库文件失败。",
  "knowledge.files_panel_description": "这里会显示当前知识库的原始文件与解析状态。",
  "knowledge.files_empty": "这个知识库里还没有文件。",
  "knowledge.file_size_unknown": "大小未知",
  "knowledge.document_run_done": "已完成",
  "knowledge.document_run_processing": "解析中",
  "knowledge.document_run_fail": "失败",
  "knowledge.document_run_unknown": "未知",
  "knowledge.delete_document_action": "删除文件",
  "knowledge.delete_document_confirm": "确定要删除文件“{name}”吗？",
  "knowledge.delete_document_failed": "删除知识库文件失败。",
  "knowledge.delete_knowledge_action": "删除知识库",
  "knowledge.delete_knowledge_confirm": "确定要删除知识库“{name}”吗？这会同时删除 RAGFlow 中对应的数据集。",
  "knowledge.delete_knowledge_failed": "删除知识库失败。",
  "knowledge.deleting_knowledge": "删除中...",
  "knowledge.mine_title": "我的知识库",
  "knowledge.mine_description": "在这里上传文件，然后在任意会话里挂载该知识库。",
  "knowledge.mine_empty": "{workspace} 里还没有知识库。",
  "knowledge.docs_count": "{count} 个文档",
  "knowledge.chunks_count": "{count} 个切片",
  "knowledge.chunk_method_naive": "通用切片",
  "knowledge.upload_action": "上传文件",
  "knowledge.uploading": "上传中...",
  "knowledge.session_external_hint": "文件保持在会话外存储；会话只挂载知识范围，不会创建隐藏数据集。",
  "knowledge.refresh_files": "刷新文件",
  "knowledge.others_title": "其他人的知识库",
  ...
  "knowledge.details_empty_title": "先从左侧选择一个知识库",
  "knowledge.details_empty_description": "选中后，这里会显示该知识库的详情、文件列表，以及上传或删除等操作。",
  "knowledge.details_shared_hint": "共享知识库只读展示，挂载到会话后可作为检索来源使用。",
  "knowledge.details_docs_label": "文档数",
  "knowledge.details_chunks_label": "切片数",
  "knowledge.details_chunk_method_label": "切片方式",
  "knowledge.status_ready": "可用",
  "knowledge.status_processing": "解析中",
  "knowledge.status_degraded": "异常",
  "knowledge.status_unknown": "未知",

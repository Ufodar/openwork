...
- 这是文档 Agent 多轮评测与运行证据的历史档案。
- 当前第二阶段文档重构的主入口，已迁移到：
  - [../2026-04-03-doc-agent-capability-model/](../2026-04-03-doc-agent-capability-model/)
- 如果目标是继续推进第二阶段设计、prompt 重构或后续 harness 工作，默认应先从新目录进入。
- 本目录继续保留，用于：
  - 回看历史评测结论
  - 追溯 hosted / raw / common-work 的运行证据
  - 解释当前第二阶段判断是如何逐步形成的

...
export OPENWORK_POD_OPENCODE_SOURCE="${OPENWORK_POD_OPENCODE_SOURCE:-external}"
# Hosted pods should prefer the already-installed external OpenCode binary.
# The downloaded sidecar remains available as an explicit fallback.
